...
fichier(s) en sortie : sortie0.txt, sortie1.txt, ... dans le dossier 'sortie'
2 arguments a passer en ligne de commands : maxTampon et longueurId, par exemple à executer dans la ligne de commande :
python scriptRequete.py 15000 15
